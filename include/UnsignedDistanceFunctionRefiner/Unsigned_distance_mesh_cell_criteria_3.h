//
// Based on: CGAL/Unsigned_distance_mesh_cell_criteria_3.h
//
// Author: Ricard Campos

#ifndef CGAL_UNSIGNED_DISTANCE_MESH_CRITERIA_3_H
#define CGAL_UNSIGNED_DISTANCE_MESH_CRITERIA_3_H
...
template <class Tr>
class Unsigned_distance_mesh_cell_criteria_3 
{
...
public:
	...
	Unsigned_distance_mesh_cell_criteria_3( const double radius_edge_bound = 2, //< radius edge ratio bound (ignored if zero)
...
}; // end Unsigned_distance_mesh_cell_criteria_3

template <typename Tr>
std::ostream& operator<<(	std::ostream& os,
							const typename Unsigned_distance_mesh_cell_criteria_3<Tr>::Cell_quality& q)
{
	return os << q.sq_size() << ", " << q.aspect();
}

} // end namespace CGAL
#endif // CGAL_UNSIGNED_DISTANCE_MESH_CRITERIA_3_H
