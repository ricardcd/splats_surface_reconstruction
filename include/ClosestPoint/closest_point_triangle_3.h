// This file is based on CGAL/internal/AABB_tree/nearest_point_triangle_3.h

#ifndef CLOSEST_POINT_TRIANGLE_3_H_
#define CLOSEST_POINT_TRIANGLE_3_H_
...
inline
typename K::Point_3
closest_point_3(const typename K::Point_3& origin,
                const typename K::Point_3& p1,
                const typename K::Point_3& p2,
                     ...
                     const K& k)
{
  ...
  if ( outside )
  {
    result = closest_point_3(p,t0,t1,t2,k);
    return false;
  }
  else
  {
...
{
  return internal_aux::closest_point_3( origin, triangle, K() ) ;
}

}  // end namespace CGAL


#endif // CLOSEST_POINT_TRIANGLE_3_H_
